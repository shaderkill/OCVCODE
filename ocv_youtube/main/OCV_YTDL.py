...
#-- Proceso principal
frontalface_cascades = cascada('D:\\opencv\\opencv\\sources\\data\\lbpcascades\\lbpcascade_frontalface_improved.xml')
profileface_cascades = cascada('D:\\opencv\\opencv\\sources\\data\\lbpcascades\\lbpcascade_profileface.xml')
